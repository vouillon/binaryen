...
(module
  ...
  ;; CHECK-TEXT:      (func $br-on-cast-desc-eq (type $7) (param $any anyref) (param $descriptor (ref null $describing))
  ;; CHECK-TEXT-NEXT:  (drop
  ;; CHECK-TEXT-NEXT:   (block $l (result (ref null $middle))
  ;; CHECK-TEXT-NEXT:    (drop
  ;; CHECK-TEXT-NEXT:     (br_on_cast_desc_eq $l anyref (ref null $middle)
  ...
  ;; CHECK-BIN-NEXT:  )
  ;; CHECK-BIN-NEXT: )
  (func $br-on-cast-desc-eq (param $any anyref) (param $descriptor (ref null $describing))
    (drop
      (block $l (result (ref null $middle))
        (br_on_cast_desc_eq $l anyref (ref null $middle)
          (local.get $any)
  ...
  ;; CHECK-TEXT:      (func $br-on-cast-desc-eq-fail (type $7) (param $any anyref) (param $descriptor (ref null $describing))
  ;; CHECK-TEXT-NEXT:  (drop
  ;; CHECK-TEXT-NEXT:   (block $l (result anyref)
  ;; CHECK-TEXT-NEXT:    (br_on_cast_desc_eq_fail $l anyref (ref null $middle)
  ;; CHECK-TEXT-NEXT:     (local.get $any)
  ;; CHECK-TEXT-NEXT:     (local.get $descriptor)
  ;; CHECK-TEXT-NEXT:    )
  ;; CHECK-TEXT-NEXT:   )
  ...
  ;; CHECK-BIN-NEXT:  )
  ;; CHECK-BIN-NEXT: )
  (func $br-on-cast-desc-eq-fail (param $any anyref) (param $descriptor (ref null $describing))
    (drop
      (block $l (result anyref)
        (br_on_cast_desc_eq_fail $l anyref (ref null $middle)
          (local.get $any)
          (local.get $descriptor)
        )
      )
  ...
  ;; CHECK-TEXT:      (func $br-on-cast-desc-eq-unreachable (type $6)
  ;; CHECK-TEXT-NEXT:  (drop
  ;; CHECK-TEXT-NEXT:   (block $l (result (ref null $middle))
  ...
  ;; CHECK-BIN-NEXT:  )
  ;; CHECK-BIN-NEXT: )
  (func $br-on-cast-desc-eq-unreachable
    (drop
      (block $l (result (ref null $middle))
        (br_on_cast_desc_eq $l anyref (ref null $middle)
          (unreachable)
    ...
    ;; CHECK-TEXT:      (func $br-on-cast-desc-eq-fail-unreachable (type $6)
    ;; CHECK-TEXT-NEXT:  (drop
    ;; CHECK-TEXT-NEXT:   (block $l (result (ref null $middle))
    ;; CHECK-TEXT-NEXT:    (block ;; (replaces unreachable BrOn we can't emit)
    ;; CHECK-TEXT-NEXT:     (drop
    ...
    ;; CHECK-BIN-NEXT:  )
    ;; CHECK-BIN-NEXT: )
    (func $br-on-cast-desc-eq-fail-unreachable
    (drop
      (block $l (result (ref null $middle))
        (br_on_cast_desc_eq_fail $l anyref (ref null $middle)
          (unreachable)
  ...
  ;; CHECK-TEXT:      (func $br-on-cast-desc-eq-unreachable-desc (type $8) (param $descriptor (ref null $describing))
  ;; CHECK-TEXT-NEXT:  (drop
  ;; CHECK-TEXT-NEXT:   (block $l (result (ref null $middle))
  ;; CHECK-TEXT-NEXT:    (br_on_cast_desc_eq $l (ref null $middle) (ref null $middle)
  ;; CHECK-TEXT-NEXT:     (unreachable)
  ;; CHECK-TEXT-NEXT:     (local.get $descriptor)
  ;; CHECK-TEXT-NEXT:    )
  ;; CHECK-TEXT-NEXT:    (unreachable)
  ...
  ;; CHECK-BIN-NEXT:  )
  ;; CHECK-BIN-NEXT: )
  (func $br-on-cast-desc-eq-unreachable-desc (param $descriptor (ref null $describing))
    (drop
      (block $l (result (ref null $middle))
        (br_on_cast_desc_eq $l anyref (ref null $middle)
          (unreachable)
  ...
  ;; CHECK-TEXT:      (func $br-on-cast-desc-eq-fail-unreachable-desc (type $8) (param $descriptor (ref null $describing))
  ;; CHECK-TEXT-NEXT:  (drop
  ;; CHECK-TEXT-NEXT:   (block $l (result (ref null $middle))
  ;; CHECK-TEXT-NEXT:    (br_on_cast_desc_eq_fail $l (ref null $middle) (ref null $middle)
  ;; CHECK-TEXT-NEXT:     (unreachable)
  ;; CHECK-TEXT-NEXT:     (local.get $descriptor)
  ;; CHECK-TEXT-NEXT:    )
  ;; CHECK-TEXT-NEXT:    (unreachable)
  ...
  ;; CHECK-BIN-NEXT:  )
  ;; CHECK-BIN-NEXT: )
  (func $br-on-cast-desc-eq-fail-unreachable-desc (param $descriptor (ref null $describing))
    (drop
      (block $l (result (ref null $middle))
        (br_on_cast_desc_eq_fail $l anyref (ref null $middle)
          (unreachable)
  ...
  ;; CHECK-BIN-NEXT:  (unreachable)
  ;; CHECK-BIN-NEXT: )
  (func $br-on-cast-desc-eq-null (param anyref) (result anyref)
    (br_on_cast_desc_eq 0 anyref (ref null $described)
      (ref.null none)
      (ref.null none)
    )
  )
  ...
  ;; CHECK-BIN-NEXT:  (unreachable)
  ;; CHECK-BIN-NEXT: )
  (func $br-on-cast-desc-eq-fail-null (param anyref) (result anyref)
    (br_on_cast_desc_eq_fail 0 anyref (ref null $described)
      (ref.null none)
      (ref.null none)
    )
  )
  ...
  (func $ref-cast-desc-eq-null-unreachable (result anyref)
    (unreachable)
    (ref.cast_desc_eq (ref null $described))
  )

  ;; CHECK-TEXT:      (func $ref-cast-desc-eq-null-unreachable-ref (type $10) (param $descriptor (ref null $middle)) (result anyref)
  ;; CHECK-TEXT-NEXT:  (ref.cast_desc_eq (ref $described)
  ;; CHECK-TEXT-NEXT:   (unreachable)
  ;; CHECK-TEXT-NEXT:   (local.get $descriptor)
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $ref-cast-desc-eq-null-unreachable-ref (type $10) (param $descriptor (ref null $middle)) (result anyref)
  ;; CHECK-BIN-NEXT:  (unreachable)
  ;; CHECK-BIN-NEXT: )
  (func $ref-cast-desc-eq-null-unreachable-ref (param $descriptor (ref null $middle)) (result anyref)
    (ref.cast_desc_eq (ref null $described)
      (unreachable)
      (local.get $descriptor)
    )
  ...
  ;; CHECK-TEXT:      (func $ref-cast-desc-eq-unreachable-ref (type $10) (param $descriptor (ref null $middle)) (result anyref)
  ;; CHECK-TEXT-NEXT:  (ref.cast_desc_eq (ref $described)
  ;; CHECK-TEXT-NEXT:   (unreachable)
  ;; CHECK-TEXT-NEXT:   (local.get $descriptor)
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $ref-cast-desc-eq-unreachable-ref (type $10) (param $descriptor (ref null $middle)) (result anyref)
  ;; CHECK-BIN-NEXT:  (unreachable)
  ;; CHECK-BIN-NEXT: )
  (func $ref-cast-desc-eq-unreachable-ref (param $descriptor (ref null $middle)) (result anyref)
  ...
  ;; CHECK-TEXT:      (func $ref-cast-desc-eq-exact-null-unreachable-ref (type $11) (param $descriptor (ref null (exact $middle))) (result anyref)
  ;; CHECK-TEXT-NEXT:  (ref.cast_desc_eq (ref (exact $described))
  ;; CHECK-TEXT-NEXT:   (unreachable)
  ;; CHECK-TEXT-NEXT:   (local.get $descriptor)
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $ref-cast-desc-eq-exact-null-unreachable-ref (type $11) (param $descriptor (ref null (exact $middle))) (result anyref)
  ;; CHECK-BIN-NEXT:  (unreachable)
  ;; CHECK-BIN-NEXT: )
  (func $ref-cast-desc-eq-exact-null-unreachable-ref (param $descriptor (ref null (exact $middle))) (result anyref)
  ...
  ;; CHECK-TEXT:      (func $ref-cast-desc-eq-exact-unreachable-ref (type $11) (param $descriptor (ref null (exact $middle))) (result anyref)
  ;; CHECK-TEXT-NEXT:  (ref.cast_desc_eq (ref (exact $described))
  ;; CHECK-TEXT-NEXT:   (unreachable)
  ;; CHECK-TEXT-NEXT:   (local.get $descriptor)
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $ref-cast-desc-eq-exact-unreachable-ref (type $11) (param $descriptor (ref null (exact $middle))) (result anyref)
  ;; CHECK-BIN-NEXT:  (unreachable)
  ;; CHECK-BIN-NEXT: )
  (func $ref-cast-desc-eq-exact-unreachable-ref (param $descriptor (ref null (exact $middle))) (result anyref)
  ...
  ;; CHECK-BIN-NEXT:  (unreachable)
  ;; CHECK-BIN-NEXT: )
  (func $ref-cast-desc-eq-null-null (param anyref) (result anyref)
    (ref.cast_desc_eq (ref null $described)
      (ref.null none)
      (ref.null none)
    )
  ...
  ;; CHECK-TEXT:      (func $ref-cast-desc-eq-null-exact (type $12) (param $any anyref) (param $middle (ref null (exact $middle))) (result (ref null (exact $described)))
  ;; CHECK-TEXT-NEXT:  (ref.cast_desc_eq (ref null (exact $described))
  ;; CHECK-TEXT-NEXT:   (local.get $any)
  ;; CHECK-TEXT-NEXT:   (local.get $middle)
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $ref-cast-desc-eq-null-exact (type $12) (param $any anyref) (param $middle (ref null (exact $middle))) (result (ref null (exact $described)))
  ;; CHECK-BIN-NEXT:  (ref.cast_desc_eq (ref null (exact $described))
  ;; CHECK-BIN-NEXT:   (local.get $any)
  ;; CHECK-BIN-NEXT:   (local.get $middle)
  ;; CHECK-BIN-NEXT:  )
  ;; CHECK-BIN-NEXT: )
  (func $ref-cast-desc-eq-null-exact (param $any anyref) (param $middle (ref null (exact $middle))) (result (ref null (exact $described)))
  ...
  ;; CHECK-TEXT:      (func $ref-cast-desc-eq-nn-unreachable (type $9) (result anyref)
  ;; CHECK-TEXT-NEXT:  (block ;; (replaces unreachable RefCast we can't emit)
  ;; CHECK-TEXT-NEXT:   (drop
  ;; CHECK-TEXT-NEXT:    (unreachable)
  ;; CHECK-TEXT-NEXT:   )
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $ref-cast-desc-eq-nn-unreachable (type $9) (result anyref)
  ;; CHECK-BIN-NEXT:  (unreachable)
  ;; CHECK-BIN-NEXT: )
  (func $ref-cast-desc-eq-nn-unreachable (result anyref)
    (unreachable)
    (ref.cast_desc_eq (ref $described))
  )
  ...
  ;; CHECK-BIN-NEXT:  (unreachable)
  ;; CHECK-BIN-NEXT: )
  (func $ref-cast-desc-eq-nn-null (param anyref) (result anyref)
    (ref.cast_desc_eq (ref $described)
      (ref.null none)
      (ref.null none)
    )
  ...
  ;; CHECK-TEXT:      (func $ref-cast-desc-eq-nn-exact (type $12) (param $any anyref) (param $middle (ref null (exact $middle))) (result (ref null (exact $described)))
  ;; CHECK-TEXT-NEXT:  (ref.cast_desc_eq (ref (exact $described))
  ;; CHECK-TEXT-NEXT:   (local.get $any)
  ;; CHECK-TEXT-NEXT:   (local.get $middle)
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $ref-cast-desc-eq-nn-exact (type $12) (param $any anyref) (param $middle (ref null (exact $middle))) (result (ref null (exact $described)))
  ;; CHECK-BIN-NEXT:  (ref.cast_desc_eq (ref (exact $described))
  ;; CHECK-BIN-NEXT:   (local.get $any)
  ;; CHECK-BIN-NEXT:   (local.get $middle)
  ;; CHECK-BIN-NEXT:  )
  ;; CHECK-BIN-NEXT: )
  (func $ref-cast-desc-eq-nn-exact (param $any anyref) (param $middle (ref null (exact $middle))) (result (ref null (exact $described)))
    ;; The cast type is exact because the descriptor is exact.
    (ref.cast_desc_eq (ref (exact $described))
      (local.get $any)
      (local.get $middle)
  ...
  ;; CHECK-TEXT:      (func $ref-cast-desc-eq-nn-to-null (type $17) (param $any-nn (ref any)) (param $middle (ref null $middle)) (result (ref null $described))
  ;; CHECK-TEXT-NEXT:  (ref.cast_desc_eq (ref $described)
  ;; CHECK-TEXT-NEXT:   (local.get $any-nn)
  ;; CHECK-TEXT-NEXT:   (local.get $middle)
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $ref-cast-desc-eq-nn-to-null (type $17) (param $any-nn (ref any)) (param $middle (ref null $middle)) (result (ref null $described))
  ;; CHECK-BIN-NEXT:  (ref.cast_desc_eq (ref $described)
  ;; CHECK-BIN-NEXT:   (local.get $any-nn)
  ;; CHECK-BIN-NEXT:   (local.get $middle)
  ;; CHECK-BIN-NEXT:  )
  ;; CHECK-BIN-NEXT: )
  (func $ref-cast-desc-eq-nn-to-null (param $any-nn (ref any)) (param $middle (ref null $middle)) (result (ref null $described))
    (ref.cast_desc_eq (ref null $described)
      (local.get $any-nn)
      (local.get $middle)
    )
...
;; CHECK-BIN-NODEBUG-NEXT:    (drop
;; CHECK-BIN-NODEBUG-NEXT:     (br_on_cast_desc_eq $block anyref (ref null $1)
;; CHECK-BIN-NODEBUG-NEXT:      (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:      (local.get $1)
;; CHECK-BIN-NODEBUG-NEXT:     )
;; CHECK-BIN-NODEBUG-NEXT:    )
...
;; CHECK-BIN-NODEBUG-NEXT:    (br_on_cast_desc_eq_fail $block anyref (ref null $1)
;; CHECK-BIN-NODEBUG-NEXT:     (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:     (local.get $1)
;; CHECK-BIN-NODEBUG-NEXT:    )
;; CHECK-BIN-NODEBUG-NEXT:   )
...
;; CHECK-BIN-NODEBUG-NEXT:  (ref.cast_desc_eq (ref null (exact $0))
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $1)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )
...
;; CHECK-BIN-NODEBUG-NEXT:  (ref.cast_desc_eq (ref (exact $0))
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $1)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )
...
;; CHECK-BIN-NODEBUG-NEXT:  (ref.cast_desc_eq (ref $0)
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $1)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )
